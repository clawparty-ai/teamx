...
| 三人协作测试 | owner+contributor+reviewer 闭环（等价 demo-team） | `tests/three-member.sh` | 同上 |
...
| 手工 E2E（验收） | 三个真实 opencode 窗口走 `/Team` 全流程 | 人工 | 见 `docs/13-demo-team.md`、`docs/08-test-cases.md` TM-04 |
...
# 手工：三个 opencode 窗口验证 TM-04（docs/13-demo-team.md）
```
